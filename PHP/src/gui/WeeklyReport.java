...
class WeeklyReport extends JDialog {
    ...
    public WeeklyReport(JFrame frame,String date) throws Exception {
        super( frame, "Weekly Report", true );
        
        String[][] reportTable = DataBaseHandler.getRawWeekly(date);
        ...
        String[][] inventoryStatistics = DataBaseHandler.getWeeklySummaryReport(date);
		...
		genButton.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				try {
					...
					FileWriter fw = new FileWriter(date+"_WeekReport.csv");
